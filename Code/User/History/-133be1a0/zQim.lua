...
-- Default springs
hl.curve("easy",           { type = "spring", mass = 0.6, stiffness = 140, dampening = 15.8273644 })
...
-- 1. Xóa khoảng trống ngoài (gaps_out) và khoảng trống trong (gaps_in) khi chỉ có 1 cửa sổ
hl.workspace_rule({ workspace = "w[tv1]", gaps_out = 0, gaps_in = 0 })
hl.workspace_rule({ workspace = "f[1]",   gaps_out = 0, gaps_in = 0 })

-- 2. Tắt viền và bo góc cho cửa sổ duy nhất đó (chỉ áp dụng cho cửa sổ dạng tiled, bỏ qua float)
hl.window_rule({
    name = "no-gaps-wtv1",
...
-- ==========================================
-- CHỤP MÀN HÌNH (LƯU VÀO CLIPBOARD)
-- ==========================================

-- Bấm SUPER + SHIFT + S để kéo chuột chọn vùng chụp (Giống Snipping Tool của Windows)
...
-- Tắt viền và bo góc khi cửa sổ ở chế độ fullscreen
hl.window_rule({
    name = "fullscreen-fix-border",
